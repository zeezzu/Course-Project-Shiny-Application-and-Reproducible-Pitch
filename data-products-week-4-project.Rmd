...
## Application
 ...
 - The application and the current presentation source codes can be found at <https://github.com/zeezzu/Developing-Data-Product---Week-4-Assignment>. The application comprises 3 files: *ui.R* (UI), *server.R* (backend) and *modelBuilding.R* (Random Forest predictor).
